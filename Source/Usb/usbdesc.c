...
const uint8_t HID_ReportDescriptor[] = {
	...
	HID_UsageMax(5),											// usage maximum (5)
	...
	HID_UsageS(0x0238),										//HID_UsageS(0x0238) (tilt-wheel) 
	HID_ReportCount(1),										// report count (1)
	HID_Input(HID_Data|HID_Variable|HID_Relative),				// input (data, variable, relative)
	HID_EndCollection,
...
const uint8_t HID_ReportDescriptor2[] = {
	...
	HID_ReportID(1),								// report ID	(1)
 	HID_UsageMin(0),					    		// USAGE_MINIMUM (0x00)   
	HID_UsageMaxS(0x023C),							// USAGE_MAXIMUM (0x023C)		
	HID_LogicalMin(0),	
	HID_LogicalMaxS(0x023C),
	...
	//Feature
	HID_UsagePageVendor(0x0A0),						//HID_UsagePageS(0xFFA0)
	HID_Usage(0x01),								// Usage 01	
	HID_Collection(HID_Application),				// collection (application)
	...
	//Vendor
	HID_UsagePageVendor(0x0FF),						//HID_UsagePageS(0xFFFF)
	HID_Usage(0x01),								// Usage 01
	HID_Collection(HID_Application),				// collection (application)
	HID_ReportID(5),								// report ID	(5)
	HID_Usage(0x01),								// Usage 01
	HID_LogicalMin(0),								// Log Min
	HID_LogicalMaxS(0x0FF),							// Log Max
	HID_ReportCount(0x03),											// report count (3)
	HID_ReportSize(8),												// report size (8)
	HID_Input(HID_Data|HID_Variable|HID_Absolute),					// input (data, variable, absolute)
	HID_EndCollection,												// end collection
...
/* Index 0x02: Product */
	(29*2 + 2),													/* bLength ( 10 Char + Type + lenght) */
	USB_STRING_DESCRIPTOR_TYPE,					/* bDescriptorType */
	'X',0,
	'A',0,
	'N',0,
