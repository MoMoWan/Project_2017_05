...
#define DATA_SIZE                       0x05              // Protocol Header: Payload size
#define COMMAND_CLASS                   0x06              // Protocol Header: Command Class
#define COMMAND_ID                      0x07              // Protocol Header: Command ID
#define PAYLOAD                         0x08              // Protocol Payload Start
#define CHECKSUM                        0x58              // Protocol Checksum location
...
#define PROXIMITY_CMD                   0x0B              // Command Class: Proximity command
