...
#define REPORT_SIZE_KB                (8)                 // 8 bytes boot keyboard report size
...
//Scroll Wheel HW Map
#define   ENCODER_DN  ((uint32_t)(SN_GPIO0->DATA >> 14) & 1)     // P0.19 Scroll Wheel encoder Up signal
#define   ENCODER_UP  ((uint32_t)(SN_GPIO0->DATA >> 15) & 1)     // P1.18 Scroll Wheel encoder Down signal
...
extern LIFTOFF_SENSOR_PARM IRSensor;
