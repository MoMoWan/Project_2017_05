...
#define PIN_LFT        ((uint32_t)(SN_GPIO0->DATA >>  3) & 1)	 // PIO0_23, Left button
#define PIN_MID        ((uint32_t)(SN_GPIO0->DATA >>  4) & 1)	 // PIO0_16, Middle button
#define PIN_RGT        ((uint32_t)(SN_GPIO0->DATA >>  5) & 1)	 // PIO0_7, Right button
#define PIN_LBCK       ((uint32_t)(SN_GPIO0->DATA >> 10) & 1)	 // PIO1_30, backward button
#define PIN_LFWD       ((uint32_t)(SN_GPIO0->DATA >> 11) & 1)	 // PIO0_13, faward button
#define PIN_RBCK       ((uint32_t)(SN_GPIO0->DATA >> 12) & 1)	 // PIO0_11, backward button
#define PIN_RFWD       ((uint32_t)(SN_GPIO1->DATA >>  1) & 1)	 // PIO0_12, faward button

#define PIN_DPI_UP		 ((uint32_t)(SN_GPIO0->DATA >> 13) & 1)	 // PIO1_29, dpi up button
#define PIN_DPI_DOWN	 ((uint32_t)(SN_GPIO0->DATA >>  1) & 1)	 // PIO0_22, dpi down button

#define PIN_PROFILE_SWITCH ((uint32_t)(SN_GPIO1->DATA >>  1) & 1)	 // PIO0_14, dpi down button
...
#define PIN_PROFLIE_BUTTON   ((uint32_t)(LPC_GPIO->PIN[1] >> 31) & 1)	 // PIO1_31, profile switch button
...
#define BTN_KYBRD             0x02              // FUNCTION_ID: Keyboard key
#define BTN_MACRO_I           0x03              // FUNCTION_ID: Macro type I (Run the ID macro "0xNN" times)       
#define BTN_MACRO_II          0x04              // FUNCTION_ID: Macro type I (Repeat the ID macro until button is released.)   
#define BTN_MACRO_III         0x05              // FUNCTION_ID: Macro type I (Repeat the ID macro until button is pressed again.)   
#define BTN_DPI               0x06              // FUNCTION_ID: DPI
#define BTN_PROFILE           0x07              // FUNCTION_ID: Profile switch
#define BTN_LIGHTING          0x08              // FUNCITON_ID: Lighting Scheme 
#define BTN_POWER             0x09              // FUNCTION_ID: power
#define BTN_MEDIA             0x0A              // FUNCTION_ID: media
#define BTN_DOUBLECKL         0x0B              // FUNCTION_ID: double click
#define BTN_HYPESHIFT         0x0C              // FUNCTION_ID: HyperShift mode
#define BTN_TURBO_KEY         0x0D              // FUNCTION_ID: Turbo mode for keyboard
#define BTN_TURBO_BUTTON      0x0E              // FUNCTION_ID: Turbo mode  for button
#define BTN_MACRO_IV          0x0F              // FUNCTION_ID: Macro type 4 , every triger will come out an upload even
//#define BTN_SCOLL             0x10              // FUNCTION_ID: Scroll 
//------------------Profile Data ---------------------------------------------------------------
...
#define INDEX_DUP                  0x07               // Button index dpi up
#define INDEX_DDN                  0x08               // BUtton index dpi down

//-----------------Scroll parameter------------------------------------------------------------------


#define SCROLL_UP_IDX              0x0A             // Button index for scroll up 
#define SCROLL_DN_IDX              0x0B             // Button index for scroll up 
...
extern TURBO turbo; 
extern BTN_PARM btnAssign[NUMBER_OF_BUTTONS];                                       // Button assignment (Profile 0 = Default Assignment)
