...
//Macro Event IDs
#define KEY_MAKE           0x01            // Keyboard key pressed
#define KEY_BREAK          0x02            // Keyboard Key released 
#define POWER_MAKE         0x03            // Power Key pressed
#define POWER_BREAK        0x04            // Power key released
#define MEDIA_MAKE         0x05            // Media key make
#define MEDIA_BREAK        0x06            // Media key released
#define BUTTON             0x08            // Mouse button  make
#define SCROLL_WHEEL       0x0A            // Mouse button  released
#define DELAY_1            0x11            // Delay(rang=1ms-255ms)
#define DELAY_2            0x12            // Delay(rang=1ms-1.05 minutes)
#define DELAY_3            0x13            // Delay(rang=1ms-4.66 hours)
#define DELAY_4            0x14            // Delay(rang=1ms-49.7 days)
#define CURSOR             0x15            // Mouse Curser,X and Y
